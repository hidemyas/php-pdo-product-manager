        ...
        <div class="container-xl">
            ...
            <div class="app-card app-card-accordion shadow-sm mb-4">
                <div class="app-card-header p-4 pb-2  border-0">
                    <h4 class="app-card-title">Ürün Yönetimi</h4>
                </div><!--//app-card-header-->
            ...
            <div class="app-card app-card-accordion shadow-sm mb-4">
                <div class="app-card-header p-3">
                    <h4 class="app-card-title">Ödeme Yöntemleri</h4>
                </div><!--//app-card-header-->
                <div class="app-card-body p-4 pt-0">
                    ...
                    <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <div class="col-auto">
                                    <h4 class="app-card-title">Yardıma mı İhtiyacınız var ?</h4>
                                </div><!--//col-->
                            </div><!--//row-->
                        </div><!--//app-card-header-->
                        <div class="app-card-body px-4">

                            <div class="intro mb-3">Aşağıdaki iletişim bilgilerinden bize ulaşarak problemlerinize çözüm üretebilirsiniz</div>
                            <ul class="list-unstyled">
                                <li><strong>Tel:</strong> +90 510 220 7550</li>
                                <li><strong>Email:</strong> <a href="mailto:info@hidemyas.org">info@hidemyas.org</a></li>
                            </ul>
                        </div><!--//app-card-body-->
                        <div class="app-card-footer p-4 mt-auto">
                            <a class="btn app-btn-secondary" href="https://www.hidemyas.org/iletisim/">İletişime Geç</a>
                        </div><!--//app-card-footer-->
                    </div><!--//app-card-->
                </div><!--//col-->
                <div class="col-12 col-md-6">
                    <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                        <div class="app-card-header p-3 border-bottom-0">
                            <div class="row align-items-center gx-3">
                                ...
                                <div class="col-auto">
                                    <h4 class="app-card-title">PRO sürümüne yükselt</h4>
                                </div><!--//col-->
                            </div><!--//row-->
                        </div><!--//app-card-header-->
                        <div class="app-card-body px-4">

                            <div class="intro mb-3">Tebrikler Uygulamayı PRO olarak kullanıyorsunuz</div>
                            <ul class="list-unstyled">
                                <li>
                        ...
                        <div class="app-card-footer p-4 mt-auto">
                            <a class="btn app-btn-primary" href="#">PRO Version</a>
                        </div><!--//app-card-footer-->
                    </div><!--//app-card-->
                </div><!--//col-->
            </div><!--//row-->
